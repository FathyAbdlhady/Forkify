# 🍴Forkify [![Netlify Status](https://api.netlify.com/api/v1/badges/ced2b781-34e4-4ae1-be44-b925b8a03c09/deploy-status)](https://app.netlify.com/projects/forkify-fathy-a/deploys)

Forkify a SPA (single page application) that allows the user to find, bookmark and write recipes, all this in a beatiful and carefully designed interface.
## ⚙️Features
